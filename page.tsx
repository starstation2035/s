  ...
  return (
    <div className="min-h-screen bg-white font-sans text-[#222222]">
      ...
      <header className="sticky top-0 z-50 bg-white border-b border-gray-100">
        <div className="max-w-[1760px] mx-auto px-6 sm:px-10 lg:px-20 py-4 flex items-center justify-between">
          ...
          <div className="flex-1 flex items-center justify-end gap-2">
            <Link href="/member2" className="hidden lg:block text-sm font-semibold p-3 hover:bg-gray-50 rounded-full transition-colors">당신의 공간을 오벤져스하세요</Link>
      ...
      <main className="max-w-[1760px] mx-auto px-6 sm:px-10 lg:px-20 py-10">
        {/* Collaboration Practice Link */}
        <div className="mb-12">
          <Link href="/member2" className="block">
            <div className="flex items-center justify-center gap-4 bg-gradient-to-r from-[#FF385C] to-[#E31C5F] text-white border border-transparent rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all hover:scale-[1.01] cursor-pointer max-w-2xl mx-auto group">
              <div className="text-center">
                <span className="font-bold text-xl block mb-1">협업 연습 시작하기 (팀원 2에게 이동)</span>
                <span className="text-white/80 text-sm">팀원들과 함께하는 깃허브 워크플로우 연습</span>
              </div>
